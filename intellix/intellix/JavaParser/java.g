...
import symtab.JavaVector;
import symtab.DummyClass;
import symtab.IndentingPrintWriter;
}
...
// Define some methods and variables to use in the generated parser.
{
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (args.length > 0 ) {
                ...
                System.err.println("Usage: java refer.JavaXref "+
                                   "<directory name>");

            // Create a writer to write the cross-reference report
            IndentingPrintWriter ipw = new IndentingPrintWriter(System.out);
    ...
    public static void parseFile(InputStream s,
        ...
        try {
            ...
            lexer.setTokenObjectClass("refer.JavaToken");
