//    $Id: GSMDecoder.java,v 1.1.1.1 2002/09/06 15:36:43 bpaduraru Exp $
...
//      throw new InvalidGSMFrameException();
	...
	private final int[] decoder(int LARcr[], int Ncr[], int bcr[], int Mcr[], int xmaxcr[], int xMcr[]) {
		int j, k;
		int erp[] = new int[40];
		int wt[] = new int[160];
		// drp is just dp0+120
	...
	private final void RPEDecoding(int xmaxcr, int Mcr, int xMcr[], int xMcrOffset, int erp[]) {
		int expAndMant[];
		int xMp[] = new int[13];
	...
	private final void APCMInverseQuantization(int xMc[], int xMcOffset, int exp, int mant, int xMp[]) {
		int i,p;
	...
	private final void longTermSynthesisFiltering(int Ncr, int bcr, int erp[], int dp0[]) {
		int ltmp;
		int k;
		int brp, drpp, Nr;
	...
	public final static void decodingOfTheCodedLogAreaRatios(int LARc[], int LARpp[]) {
		int temp1;
		int ltmp;
	...
	private final static void Coefficients_0_12(int LARpp_j_1[], int LARpp_j[], int LARp[]) {
		int i;
		int ltmp;
	...
	private final static void Coefficients_13_26(int LARpp_j_1[], int LARpp_j[], int LARp[]) {
		int i;
		int ltmp;
	...
	private final static void Coefficients_27_39(int LARpp_j_1[], int LARpp_j[], int LARp[]) {
		int i;
		int ltmp;
	...
	//      shortTermSynthesisFiltering(LARp,13,wt,s,0);
	private final void shortTermSynthesisFiltering(int rrp[], int k, int wt[], int sr[], int off) {
		int i;
		int sri, tmp1, tmp2;
		int woff = off;
		int soff = off;
