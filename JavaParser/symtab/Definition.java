...
public abstract class Definition implements Reportable {
	...
	void listReferences(IndentingPrintWriter out) {
		// if anyone references the symbol, state those references
		if (references != null & !references.isEmpty())
			references.reportIndented(out, "Referenced:");
	}
	...
	/** An abstract method used to write information about this definition
	 *  to a report file.
	 */
